...
namespace OkapiDoc
{
    public abstract class TemplateBase
    {
        ...
        [Browsable(false)]
        public OkapiInfo SwaggerModel { get; set; }

        [Browsable(false)]
        public OkapiModelInfo ClassModel { get; set; }

        [Browsable(false)]
        public OkapiMethodInfo MethodModel { get; set; }

        [Browsable(false)]
        public OkapiEnumInfo EnumModel { get; set; }
        ...
        public OkapiModelInfo GetModel(string typename)
        {
        ...
        public string JavadocComment(OkapiMethodInfo method, int indent)
        {
